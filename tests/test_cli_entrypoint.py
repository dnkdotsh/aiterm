...
"""
Tests for the command-line argument parsing and dispatching in aiterm/cli.py.
"""
...
import pytest
from aiterm import cli, handlers, review
...
def mock_handlers(mocker):
    ...
    in cli.py, preventing the actual handler code from running.
    """
...
class TestCLIEntrypoint:
    ...
    def test_review_command_dispatches_to_review_main(self, monkeypatch):
        ...
        cli.main()
        review.main.assert_called_once()
        handlers.handle_chat.assert_not_called()
