...
def _prompt_for_api_keys() -> tuple[str, str, str]:
    ...
    try:
        ...
        return openai_key.strip(), gemini_key.strip(), groq_key.strip()
    except (KeyboardInterrupt, EOFError):
        print("\n\nAPI key entry cancelled. A blank .env file will be created.")
        return "", "", ""


def _create_dotenv_file(openai_key: str, gemini_key: str, groq_key: str) -> None:
...
def _perform_first_run_setup() -> None:
    ...
    try:
        ...
        openai_key, gemini_key, groq_key = _prompt_for_api_keys()
        _create_dotenv_file(openai_key, gemini_key, groq_key)
